<?php 
	...
	function khoiTaoMau(&$mau,&$soMau){
		$mau[1] = "#337ab7"; $mau[2] = "#5cb85c"; $mau[3] = "#5bc0de"; $mau[4] = "#f0ad4e";
		$mau[5] = "#d9534f"; $mau[6] = "#fff200"; $mau[7] = "#a349a4"; $mau[8] = "#b97a57";
		$mau[9] = "#ffaec9"; $mau[10] = "#ffc90e"; $mau[11] = "#efe4b0"; $mau[12] = "#b5e61d";
		$mau[13] = "#99d9ea"; $mau[14] = "#7092be"; $mau[15] = "#971ce1"; $mau[16] = "#ff0080";
		$mau[17] = "#0fee74"; $mau[18] = "#82acff"; $mau[19] = "#ff82da"; $mau[20] = "#0000ff";
		$soMau = sizeof($mau);
	}
	function thuatToanFCFS($arrAT,$arrBT,&$arrKT,$soTienTrinh,&$thoiGianCho,&$tongTgCho,&$thoiGianLuu,&$tongTgLuu,&$thuTu,&$canBenPhai,&$tongThoiGian){
		$tongThoiGian = 0;
		$tongTgCho = 0;
		$tongTgLuu = 0;
		$min = 1;
	...
	function thuatToanSJnF($arrAT,$arrBT,&$arrKT,$soTienTrinh,&$thoiGianCho,&$tongTgCho,&$thoiGianLuu,&$tongTgLuu,&$thuTu,&$canBenPhai,&$tongThoiGian){
		$tongThoiGian = 0;
		$tongTgCho = 0;
		$tongTgLuu = 0;
		$min = 1;
	...
	function thuatToanSJF($arrAT,$arrBT,&$arrKT,$soTienTrinh,&$thoiGianCho,&$tongTgCho,&$thoiGianLuu,&$tongTgLuu,&$thuTu,&$canBenPhai,&$tongThoiGian,&$dem){
		$tongThoiGian = 0;
		$tongTgCho = 0;
		$tongTgLuu = 0;
		$min = 1;
	...
	function thuatToanRR($arrAT,$arrBT,&$arrKT,$soTienTrinh,&$thoiGianCho,&$tongTgCho,&$thoiGianLuu,&$tongTgLuu,&$thuTu,&$canBenPhai,&$tongThoiGian,&$dem,$tgLuongTu){
