...
<div class="container">
    <div class="row">
        <h1><a href="../"><span class="glyphicon glyphicon-home" aria-hidden="true"></span></a> Thuật toán phân trang
        </h1>
        ...
        <form method="post" action="" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div id="fileIP" style="margin-left: 30px; " <?php if ($optionsInput == 2) {
                    ...
                    <p>- Dòng thứ 2 là số Frames (số trang cùng ở bộ nhớ trong 1 thời điểm) - Số Frames là số
                        nguyên.</p>
                    <label>
            ...
            <div id="frmIP" <?php if ($optionsInput == 1) {
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="txtPage" name="txtPage" <?php if ($optionsInput == 2) {
                        echo "required";
                    } ?> autofocus>
                </div>
                <div class="form-group">
                    <label>Số Frames</label>
                    <input type="text" class="form-control" id="txtFrames"
                           name="txtFrames" <?php if ($optionsInput == 2) {
                        echo "required";
                    } ?> >
                </div>
            </div>
            ...
            <label class="checkbox-inline">
                <input type="checkbox" name="FIFO" value="1" <?php if ($fifo == 1) {
                    echo 'checked='.'"checked"';
                } ?> > First In First Out
            </label>
            <br>
            <label class="checkbox-inline">
                <input type="checkbox" name="OPTI" value="1" <?php if ($opti == 1) {
                    echo 'checked='.'"checked"';
                } ?> > Optimal Page Replacement
            </label>
            <br>
            <label class="checkbox-inline">
                <input type="checkbox" name="LRU" value="1" <?php if ($lru == 1) {
                    echo 'checked='.'"checked"';
                } ?> > Least Recently Used
            </label>
            <br><br>
